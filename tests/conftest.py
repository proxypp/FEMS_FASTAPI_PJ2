...
from fems_fastApi.db.utils import create_database, drop_database
from fems_fastApi.services.redis.dependency import get_redis_pool
from fems_fastApi.settings import settings
from fems_fastApi.web.application import get_app
...
async def _engine(anyio_backend: Any) -> AsyncGenerator[AsyncEngine]:
    ...
    from fems_fastApi.db.models import load_all_models
